        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 flex justify-center gap-16">
            ...
            <a
              ...
              className="flex flex-col items-center gap-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors"
            >
            ...
            >
              ...
              <span className="text-sm font-medium">{t("contactMe")}</span>
            </a>
          </div>
        </div>
      </div>
