 ...
 * виджет → «Прозрачность по построению →» ССЫЛКОЙ на дерево требований.
 * Заголовок сменён с «Код повторяет замысел» его словом (2026-08-14, событие
 * 13f7477f): акцент на прозрачности, которую гарантирует само устройство, а под
 * заголовком ТОЛЬКО формулировка Дейкстры — описание дерева снято, «мы говорим
 * про концепт вообще платформы», детали видны по ссылке. Отдельной
