...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title: "AI Platform",
    description:
      "Modular AI platform with plugin architecture. Independent plugins communicate via events (Pub/Sub pattern).",
    year: "2025",
    tags: ["TypeScript", "Next.js 16", "React 19", "Python", "Plugin Architecture"],
    githubUrl: "https://github.com/pol9kov/ai-platform",
    problem:
      "Need for a flexible AI platform where different capabilities (chat, visualization, ML) can be developed independently and communicate without tight coupling.",
    solution:
      "Built a modular platform with core library (auth, spaces, events) and independent plugins that communicate via Pub/Sub events. Plugins don't import each other directly.",
    technicalDetails: [
      "Core library: auth, spaces management, event bus (emit/on/request/handle)",
      "Plugin types: UI (chat, graph), Data/Intelligence (thoughts with RAG & LLM), Service (ML embeddings)",
      "Event-driven communication: plugins publish events without knowing subscribers",
      "Tech stack: TypeScript, Next.js 16, React 19, Python FastAPI for ML service",
      "Database: Turso (SQLite edge) with Drizzle ORM",
      "Thoughts plugin owns AI logic (RAG, prompts, LLM calls); Chat is pure UI",
    ],
    results: [
      "Fully decoupled plugin system where new plugins can be added without modifying core",
      "Clean separation: UI plugins vs Data/Intelligence plugins vs Service plugins",
      "Event-driven architecture enables easy testing and plugin replacement",
    ],
    lessonsLearned: [
      "Pub/Sub pattern is ideal for plugin communication - publishers don't need to know subscribers",
      "Separating UI from business logic (Chat UI vs Thoughts intelligence) improves maintainability",
      "Pure core library without framework dependencies enables maximum flexibility",
    ],
  },
  {
    id: "2",
